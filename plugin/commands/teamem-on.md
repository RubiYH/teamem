---
description: Activate Teamem for this session — hooks fire, monitor starts, briefings inject. Add --persist to also enable for future sessions in this project.
